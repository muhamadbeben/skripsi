// ============================================================
// LOKASI FILE  : lib/services/rapor_pdf_service.dart
//                (buat folder 'services' di dalam lib/ jika belum ada)
//
// DEPENDENSI   — tambahkan di pubspec.yaml lalu jalankan flutter pub get:
//   dependencies:
//     pdf: ^3.10.8
//     printing: ^5.12.0
//     path_provider: ^2.1.2
...
// Putih 70% opacity — pengganti PdfColors.white70 yang tidak ada di package pdf
const _putihRedup = PdfColor(1, 1, 1, 0.7);
          ...
          child: pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  item['label']!,
                  style: pw.TextStyle(color: _putihRedup, fontSize: 7),
                  textAlign: pw.TextAlign.center,
                ),
